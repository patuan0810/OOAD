		...
		<div class="col-md-12">
		    ...
		    <table class="table table-bordered table-hover">
		        ...
		        <tbody>
			                ...
			                <!-- <td>
			                	<a class="btn btn-xs btn-danger" href="delete.php?id=129"><i class="fa fa-times"></i> Xóa</a>
			                </td> -->
			                ...
			                <!-- <td>
			                	<a class="btn btn-xs btn-danger" href="delete.php?id=125"><i class="fa fa-times"></i> Xóa</a>
			                </td> -->

            ...
            <div class="col-md-12 p-b-30">
                ...
                <div class="container-table-cart pos-relative">
                    <form method="post" action="?mod=cart&act=update">
                        <div class="wrap-table-shopping-cart bgwhite">
                            ...
                            <table class="table-shopping-cart">
                                ...
                                <tr class="table-row">
                                    ...
                                    <td class="column-3 " id="gia_<?php echo $item['id']; ?>" name="<?php echo $item['gia']?>"><?php echo number_format($item['gia'],0,",",".")?><sup>đ</sup></td>
                                    <td class="column-4">
                                        ...
                                        <script>
                                            ...
                                            sl++;
                                            // alert(sl);
                                            gia = $("#gia_"+id).attr("name");
                                            var total = sl * gia;
                                            $('#total_'+id).html(number_format(total,0,",",".")+'<sup>đ</sup>')
                                            console.log(number_format(total,0,",","."));
                                            }
                        ...
                        <button type="submit" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4" name="btn_update_cart" value="Update" style="width: 126px;
                            height: 44px;
                            margin-top: 20px;
                            float: right;">Cập Nhật
                        </button>
                        <p  style="    width: 325px;height: 44px; margin-top: 29px;float: right;">Bấm vào đây để cập nhật giỏ hàng<i class="fa fa-hand-o-right" style="    padding-left: 10px;font-size: 20px;font-weight: bold;" aria-hidden="true"></i></p>
                        ...
                        <p  style=" width: 325px;height: 44px;margin-top: 29px;float: left;"><i class="fa fa-hand-o-left" style="padding-right: 10px;padding-left: 5px;font-size: 20px;font-weight: bold;" aria-hidden="true"></i>Nhấn Vào Đây Để Xóa Giỏ Hàng  </p>
                ...
                <div class="bo9 w-size18 p-l-40 p-r-40 p-t-30 p-b-38 m-t-30 m-r-0 m-l-auto p-lr-15-sm">
                    ...
                    <div class="size15 trans-0-4">
                        ...
                        <a href="?mod=cart&act=checkout" style="color: white">Tiến Hành Thanh Toán</a>
                        </button>
                    </div>
                    <?php
                        }else

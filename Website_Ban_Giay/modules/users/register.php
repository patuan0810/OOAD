    ...
    if (isset($_POST['reg_user'])) {
        ...
        if (empty($_POST['password'])) {
            ...
            if (!is_password($_POST['password'])) {
                $error['password'] = "Ít nhất tám ký tự, ít nhất một chữ hoa, một chữ thường và một số";
            } // kh?p ð?nh d?ng
    
            if($password !== $password2)
            {
              $error['password2']= "Hãy chắc chắn rằng mật khẩu của bạn phù hợp.";
          }
          else
          {
        ...
        <div class="row">
            <div class="col-md-6 p-b-30 border-r">
                <div class="p-r-20 p-r-0-lg">
                    ...
                    <img src="imgs/login4.jpg" width="100%" alt="IMG-BLOG">
                </div>
            </div>
            <div class="col-md-6 p-b-30" style="border-left: 1px solid #f5f5f5;">
                <form class="leave-comment" action="" method="POST">
                    ...
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" id="name" type="text" name="name"  placeholder="Tên">
                    </div>
                    <?php
                    ...
                    <?php
                        ...
                        ?>
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22"  type="password" name="password" placeholder="Mật Khẩu">
                    </div>
                    <?php
                    ...
                    <?php
                        ...
                        ?>
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" type="password" name="password2" placeholder="Nhập lại mật khẩu">
                    </div>
                    <div class="w-size25">
                ...
                <div class="p-t-10 p-l-50">
                    <a href="?mod=users&act=login" class="active1 sale-noti "><i class=""></i> Hủy</a>
                </div>
            </div>
        </div>
    </div>

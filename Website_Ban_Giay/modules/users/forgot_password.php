...
//        $password = md5($password);
        ...
        $num_rows = mysqli_num_rows($result);
         ...
         if ($num_rows > 0) {
            ...
            $link = "http://localhost/Website_Ban_Giay/?mod=users&act=new_password&reset_token=$reset_token";
        ...
        $error['acount'] = "Vui lòng nhập email";
        ...
        <div class="row">
            <div class="col-md-6 p-b-30 border-r">
                <div class="p-r-20 p-r-0-lg">
                    ...
                    <img src="imgs/login1.jpg" width="100%" alt="IMG-BLOG">
                </div>
            </div>

        ...
        <div class="row">
            <div class="col-md-6 p-b-30 border-r">
                <div class="p-r-20 p-r-0-lg">
                    ...
                    <img src="imgs/login.jpg" width="100%" alt="IMG-BLOG">
                </div>
            </div>
            <div class="col-md-6 p-b-30" style="border-left: 1px solid #f5f5f5;">
                <form class="leave-comment" action="" method="post">
                    ...
                    <?php
                        ...
                        ?>  
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" id="password" type="password" name="password" placeholder="Mật Khẩu">
                    </div>
                    <!-- <div class="bo4 of-hidden size15 m-b-20">
                    ...
                    <div>
                        ...
                        <div style="width: 75%;position: relative;top: 10px;left:200px">
                            <a href="?mod=users&act=forgot_password">Quên mật khẩu?</a> or <a href="?mod=users&act=register" style="color: #e65540">Đăng Ký</a>
                        </div>
                    </div>
                    <?php

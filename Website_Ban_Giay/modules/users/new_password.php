...
if(check_reset_token($reset_token)){
	...
	if (isset($_POST['btn_login'])) {
		...
		if (empty($_POST['password'])) {
			...
			$error['password'] = "Không được bỏ trống mục này";
        ...
        <div class="row">
            <div class="col-md-6 p-b-30 border-r">
                <div class="p-r-20 p-r-0-lg">
                    ...
                    <img src="imgs/login3.jpg" width="100%" alt="IMG-BLOG">
                </div>
            </div>
            <div class="col-md-6 p-b-30" style="border-left: 1px solid #f5f5f5;">
                <form class="leave-comment" action="" method="post">
                    ...
                    <div class="bo4 of-hidden size15 m-b-20">
                        <input class="sizefull s-text7 p-l-22 p-r-22" id="password" type="password" name="password" placeholder="Mật Khẩu Mới">
                    </div>
                    <div>
                        <div style="width: 25%">
                            <!-- Button -->

...
<section class="bgwhite p-t-55">
			...
			<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
				...
				<div class="flex-sb-m flex-w p-b-35">
					...
					<span class="s-text8 p-t-5 p-b-5">
						Hiển Thị <?php echo $number_rows?> Kết Quả
					</span>
				</div>
 ...
 -->
                                            ...
                                            ?>
                                        <a href="" title="Add to Cart" onclick="cart(<?php echo $product['id']; ?>)" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Thêm Vào Giỏ</a>
                                        <?php
                                            }else
                                            {
                                            ?>
                                        <a href="#" onclick="updateItem3()" title="Add to cart" id="cart" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Thêm Vào Giỏ</a>
                                        <?php } ?>
											</div>
										</div>
									</div>
                                ...
                                function updateItem3(){
									...
									<div class="block2-txt p-t-20">
										...
										<span class="block2-price m-text6 p-r-5">
											<?php echo number_format($product['gia'],0,",",".") ?><sup style="text-transform:none">đ</sup>
										</span>
									</div>
								</div>
							</div>

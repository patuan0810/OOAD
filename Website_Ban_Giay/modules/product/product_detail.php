                    ...
                    <div class="w-size16 flex-m flex-w">
                        ...
                        <div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
                            ...
                            <?php
                                ...
                                ?>
                            <a href="?mod=cart&act=show" onclick="updateItem2(<?php echo $Listproductdetail['id'] ?>)" title="Add to cart" id="cart" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Thêm Vào Giỏ</a>
                            <?php
                                }else
                                {
                                ?>
                            <a href="#" onclick="updateItem3(<?php echo $Listproductdetail['id'] ?>)" title="Add to cart" id="cart" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Thêm Vào Giỏ</a>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="block2-img wrap-pic-w of-hidden pos-relative <?php echo $labelnew; ?>">
                            ...
                            <div class="block2-overlay trans-0-4">
                                ...
                                <div class="block2-btn-addcart w-size1 trans-0-4">
                                    <!-- Button -->
                                    <a href="" title="Thêm giỏ hàng" onclick="cart(<?php echo $list['id']; ?>)" class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4">Thêm Vào Giỏ</a>
                                </div>
                            </div>
                        </div>
                        <script>
